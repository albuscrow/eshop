...
import edu.cqun.eshop.domain.Comment;
 ...
 * 
 * @see edu.cqun.eshop.dao.Comment
...
public class CommentDAO extends HibernateDaoSupport {
	...
	public Comment findById(java.lang.Long id) {
		...
		try {
			Comment instance = (Comment) getHibernateTemplate().get(
					"edu.cqun.eshop.domain.Comment", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List<Comment> findByIsMatched(Object isMatched) {
		return findByProperty(IS_MATCHED, isMatched);
	}

	public List<Comment> findByLogisticsSpeed(Object logisticsSpeed) {
		return findByProperty(LOGISTICS_SPEED, logisticsSpeed);
	}

	public List<Comment> findByAttitude(Object attitude) {
		return findByProperty(ATTITUDE, attitude);
	}

	public List<Comment> findByTotal(Object total) {
