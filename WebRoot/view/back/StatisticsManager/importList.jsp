...
<script type="text/javascript" src="js/back/StatisticsManager/importList.js"></script>

<link rel="stylesheet" type="text/css"
	href="css/ui-lightness/jquery-ui-1.10.3.css">

<link rel="stylesheet" type="text/css" href="css/back/StatisticsManager/importList.css">
  ...
  <p align="center"><span class="STYLE6">货单号
    <label>
  ...
  <table width="156%" class="bordered">
    ...
    <tr>
      ...
      <th>&nbsp;</th>
      <th>&nbsp;</th>
      <th><a href="#" title="商品编辑页面"> 编辑 </a><a href="#" title="商品删除页面"> 删除</a></th>
    </tr>
    </thead>
</table>
<p align="center">共XX页 每页10条 页数
  <label>
  <input name="textfield3" type="text" size="4">
  </label> 
  /XX页  <a href="#" title="商品管理首页">首页</a><a href="#"></a> <a href="#" title="商品管理上一页">上一页</a> <a href="#" title="商品管理下一页">下一页</a> <a href="#" title="商品管理尾页">尾页</a> <a href="#" title="商品管理刷新">刷新</a>&nbsp;<a href="#">返回</a></p>
<p align="center">
  <label>
